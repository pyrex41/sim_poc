...
var $author$project$Video$init = _Utils_Tuple2(
	{error: $elm$core$Maybe$Nothing, isGenerating: false, models: _List_Nil, outputVideo: $elm$core$Maybe$Nothing, parameters: _List_Nil, pollingVideoId: $elm$core$Maybe$Nothing, requiredFields: _List_Nil, searchQuery: '', selectedCollection: 'text-to-video', selectedModel: $elm$core$Maybe$Nothing, selectedVersion: $elm$core$Maybe$Nothing, uploadingFile: $elm$core$Maybe$Nothing, videoStatus: ''},
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		...
		var _v3 = $author$project$VideoGallery$init;
		var galleryModel = _v3.a;
		var galleryCmd = _v3.b;
...
var $author$project$Main$subscriptions = function (model) {
	var videoDetailSub = function () {
		var _v4 = _Utils_Tuple2(model.route, model.videoDetailModel);
		if (((_v4.a.$ === 'Just') && (_v4.a.a.$ === 'VideoDetail')) && (_v4.b.$ === 'Just')) {
			var videoDetailModel = _v4.b.a;
			return A2(
	...
	var simulationGallerySub = function () {
		var _v2 = model.route;
		if ((_v2.$ === 'Just') && (_v2.a.$ === 'SimulationGallery')) {
			var _v3 = _v2.a;
			return A2(
				$elm$core$Platform$Sub$map,
...
var $author$project$Main$loadSceneFromStorage = _Platform_outgoingPort(
...
var $author$project$Main$saveSceneToStorage = _Platform_outgoingPort('saveSceneToStorage', $elm$core$Basics$identity);
		...
		switch (msg.$) {
			...
			case 'SelectCollection':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{outputVideo: $elm$core$Maybe$Nothing, requiredFields: _List_Nil, selectedCollection: collection, selectedModel: $elm$core$Maybe$Nothing, selectedVersion: $elm$core$Maybe$Nothing}),
	...
	function (msg, model) {
		...
		while (true) {
			switch (msg.$) {
				...
				case 'UrlChanged':
					...
					var _v2 = function () {
						if ((newRoute.$ === 'Just') && (newRoute.a.$ === 'VideoDetail')) {
							...
							var _v4 = $author$project$VideoDetail$init(videoId);
							var detailModel = _v4.a;
							var detailCmd = _v4.b;
							return _Utils_Tuple2(
								$elm$core$Maybe$Just(detailModel),
								A2($elm$core$Platform$Cmd$map, $author$project$Main$VideoDetailMsg, detailCmd));
						} else {
							return _Utils_Tuple2($elm$core$Maybe$Nothing, $elm$core$Platform$Cmd$none);
						}
					}();
					var videoDetailModel = _v2.a;
					var videoDetailCmd = _v2.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{route: newRoute, url: url, videoDetailModel: videoDetailModel}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[videoDetailCmd, galleryCmd])));
				...
				case 'SceneGenerated':
					var sceneJson = msg.a;
					var _v7 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$sceneDecoder, sceneJson);
					if (_v7.$ === 'Ok') {
						var newScene = _v7.a;
						var uiState = model.uiState;
						return _Utils_Tuple2(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								uiState: _Utils_update(
									uiState,
									{errorMessage: $elm$core$Maybe$Nothing, isRefining: true})
							}),
				...
				case 'Undo':
					var _v18 = model.history;
					if (_v18.b) {
						var previousScene = _v18.a;
						var restHistory = _v18.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
							...
							$author$project$Main$sendSceneToThreeJs(
								$author$project$Main$sceneEncoder(previousScene)));
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				case 'Redo':
					var _v19 = model.future;
					if (_v19.b) {
						var nextScene = _v19.a;
						var restFuture = _v19.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
							...
							$author$project$Main$sendSceneToThreeJs(
								$author$project$Main$sceneEncoder(nextScene)));
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				case 'SaveScene':
					return _Utils_Tuple2(
						model,
						$author$project$Main$saveSceneToStorage(
							$author$project$Main$sceneEncoder(model.scene)));
				case 'LoadScene':
					return _Utils_Tuple2(
						model,
						$author$project$Main$loadSceneFromStorage(_Utils_Tuple0));
				case 'SceneLoadedFromStorage':
					var sceneValue = msg.a;
					var _v20 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$sceneDecoder, sceneValue);
					if (_v20.$ === 'Ok') {
						var loadedScene = _v20.a;
						var modelWithHistory = $author$project$Main$saveToHistory(model);
						return _Utils_Tuple2(
							_Utils_update(
								modelWithHistory,
								{
									initialScene: $elm$core$Maybe$Just(loadedScene),
									scene: loadedScene
								}),
							$author$project$Main$sendSceneToThreeJs(
								$author$project$Main$sceneEncoder(loadedScene)));
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				case 'KeyDown':
					...
					switch (key) {
						case 'Control':
							return _Utils_Tuple2(
								...
								$elm$core$Platform$Cmd$none);
						case ' ':
							var $temp$msg = $author$project$Main$ToggleSimulation,
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case 'g':
							var $temp$msg = $author$project$Main$SetTransformMode($author$project$Main$Translate),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case 'r':
							var $temp$msg = $author$project$Main$SetTransformMode($author$project$Main$Rotate),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case 's':
							var $temp$msg = $author$project$Main$SetTransformMode($author$project$Main$Scale),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case 'z':
							if (model.ctrlPressed) {
								var $temp$msg = $author$project$Main$Undo,
									$temp$model = model;
								msg = $temp$msg;
								model = $temp$model;
								continue update;
						...
						case 'y':
							if (model.ctrlPressed) {
								var $temp$msg = $author$project$Main$Redo,
									$temp$model = model;
								msg = $temp$msg;
								model = $temp$model;
								continue update;
				...
				case 'VideoMsg':
					...
					var _v24 = A2($author$project$Video$update, videoMsg, model.videoModel);
					var updatedVideoModel = _v24.a;
					var videoCmd = _v24.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
				...
				case 'VideoDetailMsg':
					...
					var _v26 = model.videoDetailModel;
					if (_v26.$ === 'Just') {
						var videoDetailModel = _v26.a;
						var _v27 = A2($author$project$VideoDetail$update, videoDetailMsg, videoDetailModel);
						var updatedVideoDetailModel = _v27.a;
						var videoDetailCmd = _v27.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
				...
				case 'GalleryMsg':
					...
					var _v28 = A2($author$project$VideoGallery$update, galleryMsg, model.galleryModel);
					var updatedGalleryModel = _v28.a;
					var galleryCmd = _v28.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
				...
				case 'SimulationGalleryMsg':
					...
					var _v29 = A2($author$project$SimulationGallery$update, simulationGalleryMsg, model.simulationGalleryModel);
					var updatedSimulationGalleryModel = _v29.a;
					var simulationGalleryCmd = _v29.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
				...
				default:
					...
					var _v30 = A2($author$project$Auth$update, authMsg, model.authModel);
					var updatedAuthModel = _v30.a;
					var authCmd = _v30.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
