...
var $author$project$CreativeBriefEditor$init = function (key) {
	return _Utils_Tuple2(
		{autoScenePrompt: '', briefId: $elm$core$Maybe$Nothing, category: 'luxury', error: $elm$core$Maybe$Nothing, imageUrl: '', isLoading: false, llmProvider: 'openai', navigationKey: key, platform: 'tiktok', response: $elm$core$Maybe$Nothing, selectedFile: $elm$core$Maybe$Nothing, text: '', videoUrl: ''},
...
var $author$project$VideoGallery$videoDecoder = A2(
	...
	A9(
		$elm$json$Json$Decode$map8,
		F8(
			function (id, prompt, videoUrl, modelId, createdAt, collection, parameters, metadata) {
				return {collection: collection, createdAt: createdAt, id: id, metadata: metadata, modelId: modelId, parameters: parameters, prompt: prompt, status: 'completed', videoUrl: videoUrl};
			}),
		A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
		A2($elm$json$Json$Decode$field, 'prompt', $elm$json$Json$Decode$string),
		...
		$elm$json$Json$Decode$maybe(
			A2($elm$json$Json$Decode$field, 'metadata', $elm$json$Json$Decode$value))));
var $author$project$VideoGallery$fetchVideos = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			$author$project$VideoGallery$VideosFetched,
			A2(
				$elm$json$Json$Decode$field,
				'videos',
...
var $author$project$VideoGallery$init = _Utils_Tuple2(
	{error: $elm$core$Maybe$Nothing, loading: true, selectedVideo: $elm$core$Maybe$Nothing, showRawData: false, videos: _List_Nil},
	$author$project$VideoGallery$fetchVideos);
var $elm$core$Platform$Cmd$map = _Platform_map;
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		var route = $author$project$Route$fromUrl(url);
		var _v1 = $author$project$Video$init;
		var videoModel = _v1.a;
		var videoCmd = _v1.b;
		var _v2 = $author$project$SimulationGallery$init;
		var simulationGalleryModel = _v2.a;
		var simulationGalleryCmd = _v2.b;
		var _v3 = $author$project$ImageGallery$init;
		var imageGalleryModel = _v3.a;
		var imageGalleryCmd = _v3.b;
		var _v4 = $author$project$Image$init;
		var imageModel = _v4.a;
		var imageCmd = _v4.b;
		var _v5 = $author$project$VideoGallery$init;
		var galleryModel = _v5.a;
		var galleryCmd = _v5.b;
		var _v6 = $author$project$CreativeBriefEditor$init(key);
		var creativeBriefEditorModel = _v6.a;
		var creativeBriefEditorCmd = _v6.b;
		var _v7 = $author$project$BriefGallery$init(key);
		var briefGalleryModel = _v7.a;
		var briefGalleryCmd = _v7.b;
		return _Utils_Tuple2(
			{
...
var $author$project$Main$subscriptions = function (model) {
	var videoDetailSub = function () {
		var _v11 = _Utils_Tuple2(model.route, model.videoDetailModel);
		if (((_v11.a.$ === 'Just') && (_v11.a.a.$ === 'VideoDetail')) && (_v11.b.$ === 'Just')) {
			var videoDetailModel = _v11.b.a;
			return A2(
	...
	var simulationGallerySub = function () {
		var _v9 = model.route;
		if ((_v9.$ === 'Just') && (_v9.a.$ === 'SimulationGallery')) {
			var _v10 = _v9.a;
			return A2(
				$elm$core$Platform$Sub$map,
	...
	var imageGallerySub = function () {
		var _v7 = model.route;
		if ((_v7.$ === 'Just') && (_v7.a.$ === 'ImageGallery')) {
			var _v8 = _v7.a;
			return A2(
				$elm$core$Platform$Sub$map,
	...
	var imageDetailSub = function () {
		var _v6 = _Utils_Tuple2(model.route, model.imageDetailModel);
		if (((_v6.a.$ === 'Just') && (_v6.a.a.$ === 'ImageDetail')) && (_v6.b.$ === 'Just')) {
			var imageDetailModel = _v6.b.a;
			return A2(
				$elm$core$Platform$Sub$map,
	...
	var creativeBriefEditorSub = function () {
		var _v2 = model.route;
		if ((_v2.$ === 'Just') && (_v2.a.$ === 'CreativeBriefEditor')) {
			var _v3 = _v2.a;
			return A2(
				$elm$core$Platform$Sub$map,
	...
	var briefGallerySub = function () {
		var _v0 = model.route;
		if ((_v0.$ === 'Just') && (_v0.a.$ === 'BriefGallery')) {
			var _v1 = _v0.a;
			return A2(
				$elm$core$Platform$Sub$map,
		...
		switch (msg.$) {
			...
			case 'ToggleRawData':
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $author$project$VideoGallery$fetchVideos);
		}
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UrlChanged':
				...
				var videoDetailModel = function () {
					if ((newRoute.$ === 'Just') && (newRoute.a.$ === 'VideoDetail')) {
						...
						var _v23 = $author$project$VideoDetail$init(videoId);
						var detailModel = _v23.a;
						var detailCmd = _v23.b;
				...
				var videoPrefillCmd = function () {
					var _v18 = _Utils_Tuple2(newRoute, model.pendingVideoFromImage);
					if (((_v18.a.$ === 'Just') && (_v18.a.a.$ === 'Videos')) && (_v18.b.$ === 'Just')) {
						var _v19 = _v18.a.a;
						var modelId = _v18.b.a.modelId;
						var imageUrl = _v18.b.a.imageUrl;
				...
				var imageDetailModel = function () {
					if ((newRoute.$ === 'Just') && (newRoute.a.$ === 'ImageDetail')) {
						...
						var _v15 = $author$project$ImageDetail$init(imageId);
						var detailModel = _v15.a;
						var detailCmd = _v15.b;
						return $elm$core$Maybe$Just(detailModel);
					} else {
						return $elm$core$Maybe$Nothing;
					}
				...
				var creativeBriefEditorModel = function () {
					if ((newRoute.$ === 'Just') && (newRoute.a.$ === 'CreativeBriefEditor')) {
						var _v10 = newRoute.a;
						var _v11 = $author$project$CreativeBriefEditor$init(model.key);
						var editorModel = _v11.a;
						var editorCmd = _v11.b;
						return editorModel;
					} else {
				...
				var clearedPending = function () {
					var _v7 = _Utils_Tuple2(newRoute, model.pendingVideoFromImage);
					if (((_v7.a.$ === 'Just') && (_v7.a.a.$ === 'Videos')) && (_v7.b.$ === 'Just')) {
						var _v8 = _v7.a.a;
						return $elm$core$Maybe$Nothing;
					} else {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{briefGalleryModel: briefGalleryModel, creativeBriefEditorModel: creativeBriefEditorModel, imageDetailModel: imageDetailModel, pendingVideoFromImage: clearedPending, route: newRoute, url: url, videoDetailModel: videoDetailModel}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[videoDetailCmd, imageDetailCmd, creativeBriefEditorCmd, briefGalleryCmd, galleryCmd, imageGalleryCmd, videoPrefillCmd])));
			...
			case 'SceneGenerated':
				var sceneJson = msg.a;
				var _v24 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$sceneDecoder, sceneJson);
				if (_v24.$ === 'Ok') {
					var newScene = _v24.a;
					var uiState = model.uiState;
					return _Utils_Tuple2(
			...
			case 'Undo':
				var _v36 = model.history;
				if (_v36.b) {
					var prevScene = _v36.a;
					var restHistory = _v36.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 'Redo':
				var _v37 = model.future;
				if (_v37.b) {
					var nextScene = _v37.a;
					var restFuture = _v37.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 'VideoMsg':
				...
				var _v40 = A2($author$project$Video$update, videoMsg, model.videoModel);
				var updatedVideoModel = _v40.a;
				var videoCmd = _v40.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'VideoDetailMsg':
				...
				var _v42 = model.videoDetailModel;
				if (_v42.$ === 'Just') {
					var videoDetailModel = _v42.a;
					var _v43 = A2($author$project$VideoDetail$update, videoDetailMsg, videoDetailModel);
					var updatedVideoDetailModel = _v43.a;
					var videoDetailCmd = _v43.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 'GalleryMsg':
				...
				var _v44 = A2($author$project$VideoGallery$update, galleryMsg, model.galleryModel);
				var updatedGalleryModel = _v44.a;
				var galleryCmd = _v44.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'SimulationGalleryMsg':
				...
				var _v45 = A2($author$project$SimulationGallery$update, simulationGalleryMsg, model.simulationGalleryModel);
				var updatedSimulationGalleryModel = _v45.a;
				var simulationGalleryCmd = _v45.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'ImageMsg':
				...
				var _v46 = A2($author$project$Image$update, imageMsg, model.imageModel);
				var updatedImageModel = _v46.a;
				var imageCmd = _v46.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'ImageDetailMsg':
				...
				var _v48 = model.imageDetailModel;
				if (_v48.$ === 'Just') {
					var imageDetailModel = _v48.a;
					var _v49 = A2($author$project$ImageDetail$update, imageDetailMsg, imageDetailModel);
					var updatedImageDetailModel = _v49.a;
					var imageDetailCmd = _v49.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 'ImageGalleryMsg':
				...
				var _v50 = A2($author$project$ImageGallery$update, imageGalleryMsg, model.imageGalleryModel);
				var updatedImageGalleryModel = _v50.a;
				var imageGalleryCmd = _v50.b;
				var _v51 = function () {
			...
			case 'AuthMsg':
				...
				var _v53 = A2($author$project$Auth$update, authMsg, model.authModel);
				var updatedAuthModel = _v53.a;
				var authCmd = _v53.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'CreativeBriefEditorMsg':
				var briefMsg = msg.a;
				var _v55 = A2($author$project$CreativeBriefEditor$update, briefMsg, model.creativeBriefEditorModel);
				var updatedModel = _v55.a;
				var cmd = _v55.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'BriefGalleryMsg':
				var galleryMsg = msg.a;
				var _v56 = A2($author$project$BriefGallery$update, galleryMsg, model.briefGalleryModel);
				var updatedModel = _v56.a;
				var cmd = _v56.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
