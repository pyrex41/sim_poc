...
var $author$project$Audio$init = _Utils_Tuple2(
	{audioStatus: '', error: $elm$core$Maybe$Nothing, isGenerating: false, models: _List_Nil, outputAudio: $elm$core$Maybe$Nothing, parameters: _List_Nil, pollingAudioId: $elm$core$Maybe$Nothing, requiredFields: _List_Nil, searchQuery: '', selectedCollection: 'text-to-audio', selectedModel: $elm$core$Maybe$Nothing, selectedVersion: $elm$core$Maybe$Nothing},
	$author$project$Audio$fetchModels('text-to-audio'));
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		...
		var _v8 = $author$project$AudioGallery$init;
		var audioGalleryModel = _v8.a;
		var audioGalleryCmd = _v8.b;
		var _v9 = $author$project$Audio$init;
		var audioModel = _v9.a;
		var audioCmd = _v9.b;
		return _Utils_Tuple2(
			{
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UrlChanged':
				...
				var videoDetailModel = function () {
					if ((newRoute.$ === 'Just') && (newRoute.a.$ === 'VideoDetail')) {
						...
						var _v27 = $author$project$VideoDetail$init(videoId);
						var detailModel = _v27.a;
						var detailCmd = _v27.b;
				...
				var videoPrefillCmd = function () {
					var _v22 = _Utils_Tuple2(newRoute, model.pendingVideoFromImage);
					if (((_v22.a.$ === 'Just') && (_v22.a.a.$ === 'Videos')) && (_v22.b.$ === 'Just')) {
						var _v23 = _v22.a.a;
						var modelId = _v22.b.a.modelId;
						var imageUrl = _v22.b.a.imageUrl;
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[videoDetailCmd, imageDetailCmd, audioDetailCmd, creativeBriefEditorCmd, briefGalleryCmd, galleryCmd, imageGalleryCmd, audioGalleryCmd, videoPrefillCmd])));
			...
			case 'SceneGenerated':
				var sceneJson = msg.a;
				var _v28 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$sceneDecoder, sceneJson);
				if (_v28.$ === 'Ok') {
					var newScene = _v28.a;
					var uiState = model.uiState;
					return _Utils_Tuple2(
			...
			case 'Undo':
				var _v40 = model.history;
				if (_v40.b) {
					var prevScene = _v40.a;
					var restHistory = _v40.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 'Redo':
				var _v41 = model.future;
				if (_v41.b) {
					var nextScene = _v41.a;
					var restFuture = _v41.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 'VideoMsg':
				...
				var _v44 = A2($author$project$Video$update, videoMsg, model.videoModel);
				var updatedVideoModel = _v44.a;
				var videoCmd = _v44.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'VideoDetailMsg':
				...
				var _v46 = model.videoDetailModel;
				if (_v46.$ === 'Just') {
					var videoDetailModel = _v46.a;
					var _v47 = A2($author$project$VideoDetail$update, videoDetailMsg, videoDetailModel);
					var updatedVideoDetailModel = _v47.a;
					var videoDetailCmd = _v47.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 'GalleryMsg':
				...
				var _v48 = A2($author$project$VideoGallery$update, galleryMsg, model.galleryModel);
				var updatedGalleryModel = _v48.a;
				var galleryCmd = _v48.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'SimulationGalleryMsg':
				...
				var _v49 = A2($author$project$SimulationGallery$update, simulationGalleryMsg, model.simulationGalleryModel);
				var updatedSimulationGalleryModel = _v49.a;
				var simulationGalleryCmd = _v49.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'ImageMsg':
				...
				var _v50 = A2($author$project$Image$update, imageMsg, model.imageModel);
				var updatedImageModel = _v50.a;
				var imageCmd = _v50.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'ImageDetailMsg':
				...
				var _v52 = model.imageDetailModel;
				if (_v52.$ === 'Just') {
					var imageDetailModel = _v52.a;
					var _v53 = A2($author$project$ImageDetail$update, imageDetailMsg, imageDetailModel);
					var updatedImageDetailModel = _v53.a;
					var imageDetailCmd = _v53.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 'ImageGalleryMsg':
				...
				var _v54 = A2($author$project$ImageGallery$update, imageGalleryMsg, model.imageGalleryModel);
				var updatedImageGalleryModel = _v54.a;
				var imageGalleryCmd = _v54.b;
				var _v55 = function () {
			...
			case 'AudioMsg':
				...
				var _v57 = A2($author$project$Audio$update, audioMsg, model.audioModel);
				var updatedAudioModel = _v57.a;
				var audioCmd = _v57.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'AudioDetailMsg':
				...
				var _v59 = model.audioDetailModel;
				if (_v59.$ === 'Just') {
					var audioDetailModel = _v59.a;
					var _v60 = A2($author$project$AudioDetail$update, audioDetailMsg, audioDetailModel);
					var updatedAudioDetailModel = _v60.a;
					var audioDetailCmd = _v60.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 'AudioGalleryMsg':
				...
				var _v61 = A2($author$project$AudioGallery$update, audioGalleryMsg, model.audioGalleryModel);
				var updatedAudioGalleryModel = _v61.a;
				var audioGalleryCmd = _v61.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'AuthMsg':
				...
				var _v62 = A2($author$project$Auth$update, authMsg, model.authModel);
				var updatedAuthModel = _v62.a;
				var authCmd = _v62.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'CreativeBriefEditorMsg':
				var briefMsg = msg.a;
				var _v64 = A2($author$project$CreativeBriefEditor$update, briefMsg, model.creativeBriefEditorModel);
				var updatedModel = _v64.a;
				var cmd = _v64.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'BriefGalleryMsg':
				var galleryMsg = msg.a;
				var _v65 = A2($author$project$BriefGallery$update, galleryMsg, model.briefGalleryModel);
				var updatedModel = _v65.a;
				var cmd = _v65.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
